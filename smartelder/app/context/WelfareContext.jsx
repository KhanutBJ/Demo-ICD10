...
const INIT = {
  patients: {
    P001:{ name:'นาย สมชาย ใจดี',   age:72, icon:'👴', addr:'88 ถ.พระราม 2 บางขุนเทียน', state:'active',    icd:'I63.9', adl:3,  ttl:162, locked:false, benefits:ICD_MAP.I63.benefits, suggestedAgencies:['สปสช.','กปท.','LTC Fund','กองทุนฟื้นฟูจังหวัด','อปท.'], departments:[{name:'อายุรกรรมประสาทวิทยา',icon:'🧠',color:'#6366F1'},{name:'กายภาพบำบัด',icon:'🏃',color:'#0EA5E9'},{name:'LTC / Home Care',icon:'🏠',color:'#0F6E56'}], timeline:[{date:'20 พ.ค. 2568',event:'ICD-10: I63.9 บันทึกโดยแพทย์ (Tier: STROKE_DEPENDENT)',type:'ok'},{date:'20 พ.ค. 2568',event:'Eligible → Active (TTL 180 วัน)',type:'ok'}] },
    P002:{ name:'นาง มาลี รักสุข',   age:68, icon:'👵', addr:'22 ซ.สวนพลู ราษฎร์บูรณะ',  state:'eligible',  icd:'M17.1', adl:14, ttl:null, locked:false, benefits:ICD_MAP.M17.benefits, suggestedAgencies:['สปสช.','รพ.สต.'], departments:[{name:'ออร์โธปีดิกส์',icon:'🦵',color:'#F97316'},{name:'กายภาพบำบัด',icon:'🏃',color:'#0EA5E9'}], timeline:[] },
    P003:{ name:'นาย วิชัย ศรีสุข',  age:80, icon:'👴', addr:'7/1 ซ.บางปะกอก',            state:'active',    icd:'I50.0', adl:6,  ttl:162, locked:false, benefits:ICD_MAP.I50.benefits, suggestedAgencies:['สปสช.','LTC Fund','อปท.','รพ.สต.'], departments:[{name:'อายุรกรรมหัวใจ',icon:'❤️',color:'#EC4899'},{name:'อายุรกรรมทั่วไป',icon:'🏥',color:'#0F6E56'},{name:'LTC / Home Care',icon:'🏠',color:'#17A97E'}], timeline:[] },
    P004:{ name:'นาง สุนีย์ แก้วใส', age:75, icon:'👵', addr:'15/3 ซ.วัดสิงห์ บางมด',     state:'suspended', icd:'S72.0', adl:9,  ttl:72,  locked:false, benefits:ICD_MAP.S72.benefits, suggestedAgencies:['กองทุนฟื้นฟูจังหวัด','อปท.','รพ.สต.'], departments:[{name:'ศัลยกรรมกระดูก',icon:'🦴',color:'#F59E0B'},{name:'กายภาพบำบัด',icon:'🏃',color:'#0EA5E9'}], timeline:[{date:'15 พ.ค. 2568',event:'ICD-10: S72.0 (Tier: FRACTURE_TEMPORARY) TTL 90 วัน',type:'ok'},{date:'21 พ.ค. 2568',event:'Suspended — รอรีวิว ADL (บัญชีปิด)',type:'warn'}] },
    P005:{ name:'นาย ประยุทธ์ ดีงาม',age:65, icon:'👴', addr:'44 ถ.สุขสวัสดิ์ บางมด',     state:'active',    icd:'F03',   adl:5,  ttl:null, locked:true,  benefits:ICD_MAP.F03.benefits, suggestedAgencies:['LTC Fund','อปท.','กปท.','สปสช.'], departments:[{name:'จิตเวชศาสตร์',icon:'🧠',color:'#8B5CF6'},{name:'คลินิกผู้สูงอายุ',icon:'👴',color:'#F59E0B'},{name:'LTC / Home Care',icon:'🏠',color:'#0F6E56'}], timeline:[] },
  },
  alerts:[
