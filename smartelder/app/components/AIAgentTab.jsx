...
const TOOLS = [
  ...
  { id: 'rights',    label: 'เช็คสิทธิ์ผ้าอ้อม ดูแลระยะยาว',     desc: 'ตรวจสอบสิทธิ์ผ้าอ้อมผู้ใหญ่ สปสช.' },
...
const EXAMPLES = {
  ...
  policy: 'ผู้ป่วยที่มีปัญหาการกลั้นขับถ่าย แต่ ADL = 8 (ติดบ้าน) สามารถขอรับสิทธิ์ผ้าอ้อมผู้ใหญ่จากกองทุนดูแลระยะยาว หรือ สปสช. ได้หรือไม่? มีเงื่อนไขข้อยกเว้นอย่างไรบ้าง?',
};
