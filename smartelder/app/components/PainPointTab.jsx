  ...
  const points = [
    {
      ...
      stats: 'บทที่ 5 รายงาน ม.มหิดล/สปสช. 2568: ผู้สูงอายุถูกคัดกรองเพียง 55% (6.67 ล้านจาก 13.94 ล้านคน) — ผู้สูงอายุ ~6.2 ล้านคน ไม่เคยถูกประเมินภาวะพึ่งพิงเลย และในกลุ่มที่รู้จักระบบแล้ว (338,049 คน ติดบ้าน+ติดเตียง ปี 2567) ยังเข้าถึงบริการดูแลระยะยาว จริงเพียง 60.90% ในเขตเทศบาล และ 81.99% นอกเขตเทศบาล — หมายความว่า ~58,000 คนในเมือง ไม่ได้รับบริการแม้จะอยู่ในรายชื่อ ขณะที่สิทธิ์ผ้าอ้อมต้องมี Care Plan ก่อนจึงจะเบิกได้ จึงสร้างคอขวดตกหล่น 2 ชั้น (ไม่ถูกค้นพบ → ไม่มี Care Plan → ไม่ได้ผ้าอ้อม)',
    ...
    },
    {
      ...
      stats: 'อปท. ที่เข้าร่วมโครงการผ้าอ้อมในปี 2566 มี 1,876 แห่ง ต้องบันทึกข้อมูลซ้ำ 3 ระบบ (3C กรมอนามัย / สปสช. / HOSxP รพ.) ใช้เอกสาร 4 ชุดต่อ Care Plan 1 ราย และรอรอบประชุมอนุกรรมการ ดูแลระยะยาว ที่จัดเพียง 1–2 ครั้งต่อปี งบค้างเบิกนานหลายเดือน',
    ...
    },
    {
      ...
      stats: 'งบดูแลระยะยาว 6,000 บาท/คน/ปี ครอบคลุมต้นทุนจริงเพียง 13–29% (ต้นทุนจริง 24,732–44,677 บาท/คน/ปี) ราคากลางผ้าอ้อม 9.50 บาท/ชิ้น แต่ตลาดจริง 15.27 บาท — ทำให้ กปท.หลายแห่งจัดซื้อไม่ได้ (เครือข่ายผู้ป่วยยื่นหนังสือรัฐมนตรี พ.ย. 2567 ขอปรับราคากลาง) นอกจากนี้ 20% ของ อปท.แจ้งว่าจะ "ยุติโครงการ" เมื่องบดูแลระยะยาว หมด และ 18.02 ล้านชิ้นที่แจกจ่ายปี 2566 ไม่มีระบบยืนยันว่าถึงมือผู้ป่วยจริง',
